...
Sample unittest -- main() with TestLoader.
"""
...
##         self.documentname = documentname
    ...
    def setUp(self):
        unit_tests_dbg.dbgprint('setUp')
        self.doc = minidom.parse('people.xml')

    def tearDown(self):
        unit_tests_dbg.dbgprint('tearDown')
...
def get_suite():
    suite = unittest.defaultTestLoader.loadTestsFromTestCase(MinidomTestCase)
    return suite
